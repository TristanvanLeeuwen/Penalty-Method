...
figure;plot2(m0);axis equal tight;ylabel('x_1 [km]');xlabel('x_2 [km]');
figure;plot2(mr);axis equal tight;ylabel('x_1 [km]');xlabel('x_2 [km]');
figure;plot2(m1);axis equal tight;ylabel('x_1 [km]');xlabel('x_2 [km]');
figure;plot2(m2);axis equal tight;ylabel('x_1 [km]');xlabel('x_2 [km]');
figure;plot2(m3);axis equal tight;ylabel('x_1 [km]');xlabel('x_2 [km]');
...
savefig(1:15,'../../doc/figs/2D_overthrust2');

table = [[1; 2].*infor(end,[1 2])' info1(end,[1 2])' info2(end,[1 2])' info3(end,[1 2])'];
latextable(table,'Horiz',{'reduced','$\lambda = 0.1$','$\lambda = 1$','$\lambda = 10$'},'Vert',{'iterations','PDE solves'},'Hline',[1 NaN],'format','%d','name','../../doc/figs/2D_overthrust2.tex');
