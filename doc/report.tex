...
%Moreover, the corresponding Hessian is typically a
...
\bq
\|\nabla\mcl{L}(\mbf{m}^*,\mbf{u}^*_{\lambda},\mbf{v}^*_{\lambda})\|_2\leq \sqrt{\epsilon^2 + \lambda^{-2}\mu^2\sigma^2} \leq \epsilon + \mathcal{O}(\lambda^{-1}).
\eq
\qed
\end{proof}
