...
&&+ \lambda^{-1}\left(A^{T}\!A\right)^{-1}P^T\!\left(\mbf{d} - PA^{-1}\mbf{q}\right)\nonumber\\
&&- \lambda^{-2}\left(A^{T}\!A\right)^{-1}P^T\!P\left(A^{T}\!A\right)^{-1}P^T\!\mbf{d} + \mcl{O}(\lambda^{-3})\nonumber\\
&=& \mbf{u}_{\mathrm{red}} + \lambda^{-1}A^{-1}\mbf{v}_{\mathrm{red}} + \mcl{O}(\lambda^{-2}).
\eq
We immediately find
\bq
...
&=& \lambda^{-1}A(\mbf{m})^{-T}P^T\left(\mbf{d} - PA(\mbf{m})^{-1}\mbf{q}\right) + \mcl{O}(\lambda^{-2})\nonumber\\
...
\bq
H(\mbf{m}^*_{\lambda} - \mbf{m}^*) + \lambda^{-1}F\mbf{v}^* = \mcl{L}_{\mbf{m}}(\mbf{m}^*_{\lambda}, \mbf{u}^*_{\lambda}, \mbf{v}^*_{\lambda}) + \mcl{O}(\lambda^{-2}),
\eq
where 
\[
