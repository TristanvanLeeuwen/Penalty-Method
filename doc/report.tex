...
\STATE{$k=0$}
\STATE{$\mathbf{u}^{0}_{\lambda}  = \left(A^TA + \lambda^{-1}PP^T\right)^{-1}\left(A(\mathbf{m}^{0})^T\mbf{q} + \lambda^{-1}P^T\mbf{d}\right)$}
...
\STATE{$\mathbf{u}^{k+1}_{\lambda}  = \left(A^TA + \lambda^{-1}PP^T\right)^{-1}\left(A(\mathbf{m}^{k+1})^T\mbf{q} + \lambda^{-1}P^T\mbf{d}\right)$}
