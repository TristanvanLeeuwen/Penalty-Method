...
result as the reduced method for a moderate amount of noise. Figure \ref{fig:2D_exp4} shows the results on data with 20\% Gaussian noise. Here, the penalty method
for $\lambda = 0.1$ starts to dramatically overfit after about 20 iterations. Again, both methods start overfitting. However, the penalty method for $\lambda=0.1$
overfits more dramatically this time. 
